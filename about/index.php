...
<head>
  ...
  <meta name="description" content="KPIAS" />
  <meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
  <meta name="author" content="KPIAS, 21st Century Software Solutions" />

  <!-- Page Title -->
  <title>KPIAS - Krishna Pradeep's IAS</title>
...
<!--ACTUAL PAGE CONTENT GOES HERE-->
    ...
    <section>
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-uppercasetext-theme-colored mt-0 mb-0 mt-sm-30">Welcome to <span class="text-theme-colored2">KPIAS</span></h2>
              <h4 class="mt-5 mb-15">Providing Leading Civils/Groups Coaching </h4>
    ...
    <!-- Divider: Funfact -->
    <section class="layer-overlay overlay-theme-colored-9 parallax" data-bg-img="../images/bg/bg1.jpg">
      <div class="container pt-80 pb-90 pt-md-70 pb-md-50 pb-sm-50">
        <div class="row mt-30 text-center">
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              <i class="pe-7s-smile mb-20 text-white"></i>
              <h2 data-animation-duration="2000" data-value="10" class="animate-number text-theme-colored2 font-42 font-weight-600 mt-0 mb-15">0</h2>
              <h5 class="text-white text-uppercase">Campus Locations</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              <i class="pe-7s-notebook mb-20 text-white"></i>
              <h2 data-animation-duration="2000" data-value="15" class="animate-number text-theme-colored2 font-42 font-weight-600 mt-0 mb-15">0</h2>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              ...
              <h2 data-animation-duration="2000" data-value="3000" class="animate-number text-theme-colored2 font-42 font-weight-600 mt-0 mb-15">0</h2>
              <h5 class="text-white text-uppercase">Selections</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              <i class="pe-7s-study mb-20 text-white"></i>
              <h2 data-animation-duration="2000" data-value="15000" class="animate-number text-theme-colored2 font-42 font-weight-600 mt-0 mb-15">0</h2>
              <h5 class="text-white text-uppercase">Students</h5>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="team">
      <div class="container">
        <div class="section-title mb-40">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-uppercase mb-5">Our <span class="text-theme-colored2">Director</span></h2>
              <h5 class="font-16 mt-5">Our Inspiring Leader</h5>
            </div>
          </div>
        </div>
        <div class="section-content">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="team-members mb-40">
                ...
                <div class="team-bottom-part border-1px p-15">
                  <h4 class="text-uppercase font-weight-600 m-0 pb-5">Krishna Pradeep Sir</h4>
                  <h6 class="font-13 text-gray mt-0">Director, Civils Trainer</h6>
                  <ul class="list-inline mt-15">
                    ...
                    <li class="m-0 pr-10"> <i class="fa fa-envelope-o text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">kptrainer@gmail.com</a> </li>
                    <li class="m-0 pr-10"> <i class="fa fa-globe text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">www.kpias.com</a> </li>
                  </ul>
...
<br>
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta assumenda voluptatum ibero eligendi molestias iure error animi totam laudantium aspern similique id eos at consectetur illo culpa, quisquam Quas voluptatem maiores eaque similique
                  </p>
                  </div>
