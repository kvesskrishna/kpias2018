...
<body class="has-side-panel side-panel-right fullwidth-page">
    <div id="wrapper" class="clearfix">
        ...
        <div class="main-content">
            ...
            <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="../images/bg/bg1.jpg">
                <div class="container pt-120 pb-60">
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-6">
                                <h2 class="text-theme-colored2 font-36">Achievements</h2>
          ...
          <section>
          <div class="row mt-40" style="padding:15px;">
          <div class="col-md-12" >
            <h4 class="mb-20">2017-18</h4>
            <div class="owl-carousel-6col" data-nav="true">
              <div class="item">
                <div class="attorney">
                  <div class="thumb">
                  <div style="height:200px;width:200px;background-color:#eee;color:black;text-align: center;vertical-align: middle;line-height: 200px;font-weight:bold;font-size:48px">50
                  </div>
                  </div>
                  <div class="content text-center">
                    <h5 class="author mb-0"><a class="text-theme-colored" href="#">Ranker Name</a></h5>
                    <h6 class="title text-gray font-12 mt-0 mb-0">IAS/IPS/IRS</h6>
                  </div>
                </div>
              </div>
              <div class="item">
