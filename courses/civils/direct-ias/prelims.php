                ...
                <div class="horizontal-tab product-tab">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade in active" id="tab1">
                      <h3>Prelims Examination (Screening Test)</h3>
                      <p>The preliminary exam is a screening test which is conducted to shortlist the candidates for the next stage of examination. The exam consists of one objective type paper. Minimum qualifying marks will be given for reservation candidates as per the rules.<br>

      <ul style="list-style-type: none">
      <li>Subjects  : General Studies & Mental Ability</li>
      <li>Type  : Objective Type</li>
      <li>Marks : 150 Marks</li>
      <li>Duration  : 2:30 hrs</li>
    </ul></p>
                    </div>
                            ...
                            <div class="media"> <a href="#" class="media-left"><img class="thumb img-circle media-object" alt="" src="https://placehold.it/75x75" width="75"></a>
                              <div class="media-body">
                                <ul class="review_text list-inline mt-5">
                                  ...
                                  <li>
                                    <h5 class="media-heading meta"><span class="author">Srinivas</span> – Mar 15, 2015:</h5>
                                  </li>
                                </ul>
                            ...
                            <div class="media"> <a href="#" class="media-left"><img class="thumb img-circle media-object" alt="" src="https://placehold.it/75x75" width="75"></a>
                              <div class="media-body">
                                <ul class="review_text list-inline mt-5">
                                  ...
                                  <li>
                                    <h5 class="media-heading meta"><span class="author">Yadav</span> – Jan 23, 2015:</h5>
                                  </li>
                                </ul>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec volutpat purus tempor sem molestie, sed blandit lacus posuere. Lorem ipsum dolor sit amet.</div>
                            </div>
            ...
            <div class="col-md-12 mt-30">
              ...
              <div class="products related owl-carousel-4col" data-nav="true">
                <div class="item">
                  <div class="product">
                    <div class="product-thumb"> <img alt="" src="../../../images/course/sm3.jpg" class="img-responsive img-fullwidth">
                      <div class="overlay"></div>
                    </div>
                    <div class="product-details text-center">
                      <a href="#"><h5 class="product-title">Degree with IAS</h5></a>
                      <div class="price"><ins><span class="amount">Civils</span></ins></div>
                      <div class="btn-add-to-cart-wrapper">
                        <a class="btn btn-default btn-xs btn-add-to-cart" href="#">More..</a>
                      </div>
                    </div>
                  </div>
                </div>
