...
<section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="../../images/bg/bg1.jpg">
                <div class="container pt-120 pb-60">
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-6">
                                <h2 class="text-theme-colored2 font-36">Groups</h2>
            ...
            <section>
                <div class="container">
                    <h3 class="text-center mb-30">Groups I & Group II</h3>
                    <div class="row">

                        <div class="col-md-6">
                            <div class="heading-line-bottom">
                                <h4 class="heading-title">Group I</h4>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="heading-line-bottom">
                                <h4 class="heading-title">Group II</h4>
                            </div>
